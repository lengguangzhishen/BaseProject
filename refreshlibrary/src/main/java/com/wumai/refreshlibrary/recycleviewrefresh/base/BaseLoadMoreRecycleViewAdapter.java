package com.wumai.refreshlibrary.recycleviewrefresh.base;
...
import com.wumai.refreshlibrary.recycleviewrefresh.android5.MaterialProgressBarSupport;
...
//                ((FooterViewHolder) holder).mProgressView.stopProgress();
    ...
    public static class FooterViewHolder extends BaseRecyclerViewAdapter.BaseViewHolder {
        ...
        protected void findView() {
            mProgressView = (MaterialProgressBarSupport) findViewById(R.id.progress_view);
