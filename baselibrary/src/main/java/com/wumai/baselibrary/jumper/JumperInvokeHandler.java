...
import com.wumai.baselibrary.BuildConfig;
import com.wumai.baselibrary.ReflectUtils;
import com.wumai.baselibrary.jumper.annotation.ActivityInfo;
import com.wumai.baselibrary.jumper.annotation.BroadcastInfo;
import com.wumai.baselibrary.jumper.annotation.Extra;
import com.wumai.baselibrary.jumper.annotation.IntentFlag;
import com.wumai.baselibrary.jumper.annotation.IntentType;
import com.wumai.baselibrary.jumper.annotation.IntentUri;
...
public class JumperInvokeHandler implements InvocationHandler {
    ...
    public Object invoke(final Object proxy, final Method method, final Object[] args) throws Throwable {
        ...
        LinkedList<ParamHolder> holderList = new LinkedList<>();
        ...
        for (ParamHolder holder : holderList) {
            ...
            } else if (ReflectUtils.isSubclassOf(clz, Serializable.class)) {
                intent.putExtra(key, (Serializable) o);
            } else if (ReflectUtils.isSubclassOf(clz, Parcelable.class)) {
                intent.putExtra(key, (Parcelable) o);
            } else if (ReflectUtils.isSubclassOf(clz, Parcelable[].class)) {
                intent.putExtra(key, (Parcelable[]) o);
            } else if (ReflectUtils.isSubclassOf(clz, ArrayList.class)) {
                final Type listType = holder.genericType;
                ArrayList list = (ArrayList) o;
                if (ReflectUtils.checkGenericType(listType, String.class)) {
                    intent.putStringArrayListExtra(key, list);
                } else if (ReflectUtils.checkGenericType(listType, Integer.class)) {
                    intent.putIntegerArrayListExtra(key, list);
                } else if (ReflectUtils.checkGenericType(listType, CharSequence.class)) {
                    intent.putCharSequenceArrayListExtra(key, list);
                } else if (ReflectUtils.checkGenericType(listType, o.getClass())) {
        ...
        if (sendBroadcast) {
            ...
            return intent;
        } else if (ReflectUtils.isSubclassOf(method.getReturnType(), IntentHandler.class)) {
