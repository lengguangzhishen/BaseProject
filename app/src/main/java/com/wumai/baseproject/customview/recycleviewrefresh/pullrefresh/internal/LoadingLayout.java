...
import com.wumai.baseproject.customview.recycleviewrefresh.pullrefresh.ILoadingLayout;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
    ...
    protected ImageView mHeaderProgress;
    ...
    public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
        ...
        mAnimationDrawable = (AnimationDrawable) mHeaderProgress.getBackground();
...
//            mHeaderImage.setBackgroundResource(R.drawable.refresh_frame_anim);
